...
<script type="text/javascript">
    ...
    <div class="main_layout">
        ...
        <div class="layouta">
            ...
            <tr>
            <td class="tidi" runat="server">Complainant</td>
            <td class="tidi"><asp:Label id="comp_name" runat="server"></asp:Label></td>
            </tr>

            <tr>
            <td class="tidi" runat="server">Complainant Email Address</td>
            <td class="tidi"><asp:Label id="emailname" runat="server"></asp:Label></td>
            </tr>

            <tr>
            <td class="tidi" runat="server">Complainant Contact Number</td>
            <td class="tidi"><asp:Label id="contact_num" runat="server"></asp:Label></td>
            </tr>
                
            <tr>
            <td class="tidi" runat="server">Complainant CNIC</td>            
