<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PendingComplaints.aspx.cs" Inherits="NIFT_CMS.PendingComplaints" MaintainScrollPositionOnPostback="true" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="main_layout">
        ...
        <h3 style="color:white; text-align: center; margin-top: 10px;margin-left: 100px;">PENDING COMPLAINTS</h3>
         <%-- /////////////// --%>

        <div class="layout">
            <h3 class="hd-top" runat="server">Pending Complaints</h3>
