<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InprogressComplaints.aspx.cs" Inherits="NIFT_CMS.InprogressComplaints" MaintainScrollPositionOnPostback="true" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main_layout">
        ...
        <div class="layout">
            <h3 class="hd-top" runat="server">In-Progress Complaints</h3>
