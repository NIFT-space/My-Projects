...
namespace ChequePro.DAL
{
    public class DBFactoryChequePro : DBFactory
    {
        ...
        public AuthDetails get_AuthBankUser_SessionToken(string H_AuthToken, string H_AuthSecretKey, int bankID)
        {
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        cs.Processdate = dr["Processdate"] == DBNull.Value ? "" : Convert.ToDateTime(dr["Processdate"]).ToString("dd-MM-yyyy");
                        ...
                        cs.ReceiverBankName = dr["ReceiverBankName"] == DBNull.Value ? "" : dr["ReceiverBankName"].ToString();
                        cs.ReceiverBranchName = dr["ReceiverBranchName"] == DBNull.Value ? "" : dr["ReceiverBranchName"].ToString();
                        cs.ReceiverBankBranchName = dr["ReceiverBankBranchName"] == DBNull.Value ? "" : dr["ReceiverBankBranchName"].ToString();
                        cs.SenderBankName = dr["SenderBankName"] == DBNull.Value ? "" : dr["SenderBankName"].ToString();
                        cs.SenderBranchName = dr["SenderBranchName"] == DBNull.Value ? "" : dr["SenderBranchName"].ToString();
                        cs.SenderBankBranchName = dr["SenderBankBranchName"] == DBNull.Value ? "" : dr["SenderBankBranchName"].ToString();
                        dt.Add(cs);
                    }
                }
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        dt.SenderBankName = dr["SenderBankName"] == DBNull.Value ? "" : dr["SenderBankName"].ToString();
                        dt.SenderBranchName = dr["SenderBranchName"] == DBNull.Value ? "" : dr["SenderBranchName"].ToString();
                        ...
                        dt.Clg_Chq_Count = dr["Clg_Chq_Count"] == DBNull.Value ? "" : dr["Clg_Chq_Count"].ToString();
                        dt.Rtn_Chq_Count = dr["Rtn_Chq_Count"] == DBNull.Value ? "" : dr["Rtn_Chq_Count"].ToString();
                        dt.Tot_Chq_Count = dr["Tot_Chq_Count"] == DBNull.Value ? "" : dr["Tot_Chq_Count"].ToString();
                    }
                }
